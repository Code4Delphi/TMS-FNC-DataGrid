...
type
  TCellColoringAdvanced = class(TForm)
    pnTop: TPanel;
    GroupBox2: TGroupBox;
    btnClose: TButton;
...
var
  CellColoringAdvanced: TCellColoringAdvanced;

implementation

{$R *.dfm}

procedure TCellColoringAdvanced.FormCreate(Sender: TObject);
begin
  Self.ConfigDataGrid;
...
procedure TCellColoringAdvanced.ConfigDataGrid;
begin
...
procedure TCellColoringAdvanced.btnGroupClick(Sender: TObject);
begin
  TMSFNCDataGrid1.BeginUpdate;
...
procedure TCellColoringAdvanced.TMSFNCDataGrid1GetCustomGroup(Sender: TObject; ACell: TTMSFNCDataGridCellCoord;
  AData: TTMSFNCDataGridCellValue; ALevel: Integer; var AGroup: string);
begin
...
procedure TCellColoringAdvanced.DataSource1DataChange(Sender: TObject; Field: TField);
begin
  StatusBar1.Panels[0].Text := 'Total: ' + FDQuery1.RecordCount.ToString;
end;

procedure TCellColoringAdvanced.btnOpenQueryClick(Sender: TObject);
begin
  FDQuery1.Open;
end;

procedure TCellColoringAdvanced.btnCloseClick(Sender: TObject);
begin
  FDQuery1.Close;
end;

procedure TCellColoringAdvanced.btnUngroupClick(Sender: TObject);
begin
  TMSFNCDataGrid1.UnGroup;
end;

procedure TCellColoringAdvanced.btnCollapseAllNodesClick(Sender: TObject);
begin
  TMSFNCDataGrid1.CollapseAllNodes;
end;

procedure TCellColoringAdvanced.btnExpandAllNodesClick(Sender: TObject);
begin
