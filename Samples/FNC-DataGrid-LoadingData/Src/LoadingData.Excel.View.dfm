object LoadingDataExcelView: TLoadingDataExcelView
  Left = 0
  Top = 0
  ActiveControl = TMSFNCDataGrid1
  Caption = 'TMS FNC DataGrid - Loading Excel data (XLS)'
  ClientHeight = 685
  ClientWidth = 956
  Color = clBtnFace
  ...
  object pnTop: TPanel
    ...
    object btnImportDepartments: TButton
      ...
      Width = 208
      Height = 25
      Caption = 'Import Excel Departments'
      TabOrder = 1
      OnClick = btnImportDepartmentsClick
    end
    object btnExportXLS: TButton
      Left = 533
      Top = 17
      Width = 128
      Height = 25
