...
type
  TAutoCompleteNormal = class(TForm)
  ...
  private
    ...
    procedure PopulateAutoCompleteItems;
...
procedure TAutoCompleteNormal.FormCreate(Sender: TObject);
begin
...
procedure TAutoCompleteNormal.ConfigureAutoComplete;
begin
  TMSFNCDataGrid1.Options.Editing.AutoComplete.&Type := gactNormal;
  TMSFNCDataGrid1.Options.Editing.DirectDropDown := True;
  Self.PopulateAutoCompleteItems;
  Self.UpdateCaseSensitive;
end;

procedure TAutoCompleteNormal.chkCaseSensitiveClick(Sender: TObject);
begin
  Self.UpdateCaseSensitive;
end;

procedure TAutoCompleteNormal.PopulateAutoCompleteItems;
begin
...
procedure TAutoCompleteNormal.UpdateCaseSensitive;
begin
