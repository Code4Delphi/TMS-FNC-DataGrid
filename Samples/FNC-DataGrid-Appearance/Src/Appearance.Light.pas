...
var
  AppearanceLight: TAppearanceLight;
...
procedure TAppearanceLight.ConfigDataGrid;
begin
...
function TAppearanceLight.FormatTarget(AValue: Double): string;
begin
...
function TAppearanceLight.StatusColor(const AStatus: string): TColor;
begin
...
function TAppearanceLight.AvatarColor(ARow: Integer): TColor;
const
