...
var
  AppearanceDark: TAppearanceDark;
...
procedure TAppearanceDark.FormCreate(Sender: TObject);
begin
...
procedure TAppearanceDark.ConfigDataGrid;
begin
...
function TAppearanceDark.StatusColor(const AStatus: string): TColor;
begin
...
function TAppearanceDark.StatusTextColor(const AStatus: string): TColor;
begin
